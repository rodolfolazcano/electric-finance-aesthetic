    ...
    items: [
      {
        ...
        subTabs: [
          ...
          { value: "plazo-fijo-uva", label: "PF UVA" },
          { value: "fci", label: "FCI" },
          { value: "lecap-caucion", label: "LECAP/Caución" },
          { value: "comparador", label: "Comparador" },
          { value: "inflacion-uva", label: "Inflación UVA" },
          { value: "tasas", label: "Tasas" },
          { value: "cuota", label: "Cuota" },
          { value: "van-tir", label: "VAN/TIR" },
          { value: "bono", label: "Bonos" },
          { value: "porcentajes", label: "Porcentajes" },
    ...
    items: [
      {
        ...
        shortLabel: "Sectores",
        subTabs: [
          { value: "panorama", label: "1 · Panorama" },
          { value: "intermarket", label: "2 · Intermarket" },
          { value: "analisis", label: "3 · Análisis" },
          { value: "valuacion", label: "4 · Valuación" },
          { value: "matriz", label: "5 · Matriz" },
          { value: "cartera", label: "6 · Cartera" },
          { value: "oportunidades", label: "7 · Oportunidades" },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Bitcoin,
        subTabs: [
          { value: "hft", label: "HFT Bot" },
          { value: "pares", label: "Pares OBI" },
          { value: "estrategias", label: "BB+RSI" },
          { value: "mae-mfe", label: "MAE/MFE" },
          { value: "pairs", label: "Pairs" },
          { value: "quant-lab", label: "Quant Lab" },
