  ...
  return (
    <Card className={cn("p-4", borderColor)}>
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div
          className={cn("text-[13px] px-2 py-1 rounded font-mono font-bold border", headerColor)}
        >
      ...
      <div className="relative mb-4">
        ...
        <div className="flex items-center justify-between gap-1 px-2 py-3">
          ...
          <div className="flex flex-col items-center z-10">
            <div
              className={cn(
                "w-14 text-center px-2 py-1.5 rounded text-[13px] font-mono font-bold border",
        ...
        {mainBreakPoint && cascadeHealth !== "intacta" && (
          <div className="text-center mt-1">
            <span className="text-[12px] font-mono text-red-400">
              [ADVERTENCIA] Ruptura en: {mainBreakPoint}
            </span>
          </div>
        )}
      </div>
      ...
      <div className="space-y-1.5 mb-3">
        {links.map((link, i) => (
          <div
            ...
            className={cn(
              "flex items-start gap-2 px-2.5 py-1.5 rounded border text-[13px]",
              link.intact
                ? "bg-emerald-500/5 border-emerald-500/15"
                : "bg-red-500/5 border-red-500/15",
            )}
          >
            <span>{link.intact ? "[OK]" : "[ERROR]"}</span>
      ...
      <div
        className={cn(
          "px-3 py-2 rounded-lg text-[13px] font-mono leading-relaxed border",
          cascadeHealth === "intacta"
