...
import { computePVariance, impliedPFromReturns, mean, std } from "@/lib/herramientas/math/stats";
import {
  detectCalculationAnomalies,
  type AnomalyReport,
} from "@/lib/herramientas/social/anomaly-detector";
import { getRiskFreeRateSync } from "@/lib/herramientas/risk-free-rate";
