...
export const BYMA_HEDGE_TICKERS: string[] = [
  "GGAL.BA", "YPFD.BA", "PAMP.BA", "BMA.BA", "TECO2.BA",
  "EDN.BA", "TXAR.BA", "ALUA.BA", "CRES.BA", "CEPU.BA",
  "TRAN.BA", "COME.BA", "CTIO.BA", "LOMA.BA", "MIRG.BA",
  "METR.BA", "SUPV.BA", "VALO.BA", "HARG.BA", "CGPA2.BA",
  "DSX.BA", "INVJ.BA", "LEDE.BA", "LONG.BA", "OEST.BA",
  "PATA.BA", "RIGO.BA", "SAMI.BA", "SEMI.BA", "BHIP.BA",
  "BOLT.BA", "BPAT.BA", "BYMA.BA", "CECO2.BA", "DGCU2.BA",
  "FERR.BA", "GCLA.BA", "GRIM.BA", "HAVA.BA", "IRSA.BA",
  "MOLA.BA", "MORI.BA", "MTR.BA", "PGR.BA", "PLAR.BA",
  "POLL.BA", "ROSE.BA", "SALO.BA", "TGLT.BA", "TOMY.BA",
];
...
export function detectarMonedaPosiciones(positions: Array<{ moneda?: string }>): "ARS" | "USD" | "mixto" {
