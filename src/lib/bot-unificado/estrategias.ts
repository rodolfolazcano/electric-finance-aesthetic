...
export const ESTRATEGIAS: DefinicionEstrategia[] = [
  ...
  {
    id: "cedears-entrada",
    nombre: "CEDEARs — Señales de Entrada (Top Volumen)",
    descripcion: "Scanner multi-indicador sobre top 20 CEDEARs por volumen de hoy (de 369 del JSON). RSI+MACD+SMA+Bollinger+Volumen.",
    fuenteAcademica: "Análisis técnico compuesto (Wilder RSI, Bollinger, MACD, SMA crossover) + filtro liquidez",
    cadaMinutos: 90,
    desde: "11:00",
    hasta: "23:00",
  ...
  {
    id: "cedears-oversold",
    nombre: "CEDEARs — Oversold Extremo (Top Volumen)",
    descripcion: "Filtro agresivo top 20 por volumen con RSI < 30 para entrada en sobreventa extrema.",
    fuenteAcademica: "Mean-reversion RSI (Wilder) + stops por ATR + liquidez",
    cadaMinutos: 90,
    desde: "11:00",
    hasta: "23:00",
