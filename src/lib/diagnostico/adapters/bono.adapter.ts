...
export const bonoAdapter: AssetAdapter = {
  tipo: "bono",
  ...
  async enriquecer(input: PortfolioAssetInput, clasificacion: Clasificacion, ctx?: PipelineContext): Promise<PositionEnriquecida> {
    ...
    // Convertir precio a USD si es necesario (misma lógica que Dashboard Diario)
    ...
    const precioEnUSD = isHardDollar && tcMep != null && tcMep > 0
      ? precioIOL / tcMep  // ARS → USD (86,000 ARS / 1000 MEP = 86 USD)
      : precioIOL;
