  ...
  .handler(
    async ({
      ...
      try {
        ...
        const cotizaciones: IOLCotizacion[] = titulos.map(
          (t: any): IOLCotizacion => ({
            simbolo: t.simbolo || "",
  ...
  .handler(
    async ({
      ...
      try {
        ...
        const acciones: IOLCotizacion[] = titulos.map(
          (t: any): IOLCotizacion => ({
            simbolo: t.simbolo || "",
            nombre: t.descripcion || t.nombre || t.simbolo || "",
            precio: t.ultimoPrecio || t.precio || 0,
  ...
  .handler(
    async ({
      ...
      try {
        ...
        const bonos: IOLCotizacion[] = titulos.map(
          (t: any): IOLCotizacion => ({
            simbolo: t.simbolo || "",
            nombre: t.descripcion || t.nombre || t.simbolo || "",
            precio: t.ultimoPrecio || t.precio || 0,
  ...
  .handler(
    async ({
      ...
      try {
        ...
        let ons: IOLCotizacion[] = titulos.map(
          (t: any): IOLCotizacion => {
            ...
            return {
              ...
              variacionPct:
                cierre > 0 ? ((ultimoPrecio - cierre) / cierre) * 100 : 0,
        ...
        ons = ons.filter((o) => o.precio > 0 || o.puntas.compra > 0 || o.puntas.venta > 0 || o.cierre > 0 || o.volumen > 0);
        ...
        const necesitaEnriquecer = ons.filter(
          (o) => o.precio > 0 && (o.puntas.compra === 0 || o.puntas.venta === 0 || o.cierre === 0 || o.volumen === 0),
        );
          ...
          const enriquecer = async (simbolo: string): Promise<Partial<IOLCotizacion> | null> => {
            try {
              ...
              return {
                ...
                variacionPct: cierre > 0 ? (((d.ultimoPrecio ?? d.precio ?? 0) - cierre) / cierre) * 100 : 0,
  ...
  .handler(
    async ({
      ...
      try {
        ...
        const cedears: IOLCotizacion[] = titulos.map(
          (t: any): IOLCotizacion => ({
            simbolo: t.simbolo || "",
            nombre: t.descripcion || t.nombre || t.simbolo || "",
            precio: t.ultimoPrecio || t.precio || 0,
