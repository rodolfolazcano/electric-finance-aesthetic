...
export const fetchRiesgoPais = createServerFn({ method: "GET" }).handler(
  async (): Promise<RiesgoPaisData> => {
    try {
...
export const fetchLetras = createServerFn({ method: "GET" }).handler(
  async (): Promise<LetraData[]> => {
    try {
