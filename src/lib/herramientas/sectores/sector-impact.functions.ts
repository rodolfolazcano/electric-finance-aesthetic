    ...
    async ({
          ...
          try {
            ...
            return {
              ...
              movimientoProyectado:
                movimientoProyectado != null ? Math.round(movimientoProyectado * 100) / 100 : null,
              fiable: r2 >= 0.5,
            };
          } catch {
            return {
      ...
      return {
        base: {
          ...
          r2: 1,
          correlacion: 1,
          movimientoProyectado: data.movePercent,
          fiable: true,
        },
        results: results.sort(
          (a, b) => (b.movimientoProyectado ?? -999) - (a.movimientoProyectado ?? -999),
        ),
        intermarket: intermarket.sort(
          (a, b) => Math.abs(b.correlacion ?? 0) - Math.abs(a.correlacion ?? 0),
        ),
      };
    },
  );
